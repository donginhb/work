...
void CShellTree::PopulateTree(int nFolder) 
{
	...
	//Marked by Wusc
	//if not marked Disk A: will be selected, and it will pop
	//up messagebox to tell that there is no floppy in the disk
...
void CShellTree::TunnelTree(CString szFindPath)
{
	...
	//Marked by Wusc
	//For the root is not My Computer but Disk A:
	//So just think it as the first child
