...
void CNewWizDialog::GetPageData() 
{
	m_strArray.RemoveAll();
	m_strArray2.RemoveAll();
	m_strArray3.RemoveAll();
	...
	{
		pPage = (CNewWizPage*)m_PageList.GetNext(Pos);
		m_strArray.Add(pPage->m_strData);
		m_strArray2.Add(pPage->m_strData2);
		m_strArray3.Add(pPage->m_strData3);
	}
}
