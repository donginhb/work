#if !defined(AFX_DATABROWSEWND_H__C9DE2DC8_DB98_426E_BAB7_847544316833__INCLUDED_)
#define AFX_DATABROWSEWND_H__C9DE2DC8_DB98_426E_BAB7_847544316833__INCLUDED_
...
class CRestrictedData : public CObject
{
public:
	CRestrictedData(){};
	~CRestrictedData(){};
	int m_nKbps;
	CWordArray m_wdArrayFreq;
	CByteArray m_btArrayMono;
};

class CDataBrowseWnd : public CWnd
{
// Construction
public:
	CDataBrowseWnd();
