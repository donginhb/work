...
protected:
	_Application15		  m_app;
	Presentations15       m_presentations;
	_Presentation15       m_presentation;
	Slides15              m_slides;
	SlideShowSettings15   m_slideshow;
	SlideShowWindows15    m_slideshowwindows;
	SlideShowWindow15     m_slideshowwindow;
	SlideShowView15		  m_pView;
