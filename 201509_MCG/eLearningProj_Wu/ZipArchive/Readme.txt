...
To be notified about the future library updates, sign up for the newsletter.

Platforms supported: 
- Windows 9x\Me\NT\2000\XP (MFC and STL) Microsoft Visual C++ 6.0 (.NET compatible ), Borland C++ 
